    ...
    <div className='md:mt-6 lg:mt-4 h-screen flex bg-gray-bg1'>
      <div className='w-full max-w-md m-auto bg-white rounded-lg border border-primaryBorder shadow-default py-10 px-16 sm:mt-16'>
        ...
        <form onSubmit={handleFormSubmit}>
          <div>
            <label htmlFor='email' className="text-xl font-normal text-grey-600">Email</label>
            <input
              type='email'
          ...
          <div>
            <label htmlFor='password' className="text-xl font-normal text-grey-600">Password</label>
            <input
              type='password'
